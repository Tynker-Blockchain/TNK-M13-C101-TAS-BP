...
def home():
    ...
    # Create a variable transactionData
    ...
    if(isSignedIn):
        ...
        if(account):
            ...
            # Create amountList, colorList and indicesTransactions with three entries each
            
            
            # Create traceTnx dict with x,y,name, type, maker keys
            
            
    
            # Create layoutTnx dict with title,xaxis,yaxis keys
            
            

            # Create transactionData dict with trace and layout keys and pass them [traceTnx] and layoutTnx
    ...
    # Send transactionDate as transaction data    
